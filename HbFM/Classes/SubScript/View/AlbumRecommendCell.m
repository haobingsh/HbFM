...
#import "OtherRecommand.h"
#import "AlbumDetailController.h"
#import "UIView+FMLayout.h"
#import "Base.h"

@interface AlbumRecommendCell()<UITableViewDataSource,UITableViewDelegate>
@property (strong, nonatomic) IBOutlet UITableView *tableView;
@end

@implementation AlbumRecommendCell

- (void)setOtherRecommands:(OtherRecommands *)otherRecommands{
...
{
    OtherRecommand *otherRecommand = self.otherRecommands.list[indexPath.row];
