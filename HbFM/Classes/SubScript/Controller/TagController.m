...
@interface TagController ()<TagSortViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (weak, nonatomic) IBOutlet UISegmentedControl *segmentControl;
// 遮盖层
@property (nonatomic, strong) UIView *coverView;
@property (nonatomic, strong) TagSortView *sortView;
// 标志下拉框的显示与隐藏
...
- (void)initView
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([AlbumDetaiVedioCell class]) bundle:nil] forCellReuseIdentifier:vedioCellId];

    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([RecommendsCell class]) bundle:nil] forCellReuseIdentifier:recommendCellId] ;
