...
@implementation FMMiddleView

static FMMiddleView *_shareInstance;

+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [FMMiddleView middleView];
    }
...
+ (instancetype)middleView {
    ...
    FMMiddleView *middleView = [[[NSBundle bundleForClass:self] loadNibNamed:@"FMMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
