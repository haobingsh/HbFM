...
@interface AdPicView ()<UIScrollViewDelegate>
{
...
-(void)setPicModels:(NSArray<id <AdPicProtocol>> *)picModels
{
    ...
    for (int i = 0; i< count; i++) {
        ...
        id<AdPicProtocol> picM = picModels[i % baseCount];
        // 1. 创建控件
...
- (void)jumpToLink:(UITapGestureRecognizer *)gester {
    ...
    id<AdPicProtocol> adM = self.picModels[tag];
